...
object MantisPersistence {

  /**
    * Create [[cats.Resource]] with [[MantisPersistence]].
    */
  def resource[F[_]: Concurrent]: Resource[F, MantisPersistence[F]] =
    Resource.pure(new MantisPersistence[F])
